...
class EULAWindow:
    ...
    def create_eula_file(self):
        ...
        with open(self.path + "eula.txt", "w") as start_file:
            ...
            if current.month == 0: month = "Jan"
            elif current.month == 1: month = "Feb"
            elif current.month == 2: month = "Mar"
            elif current.month == 3: month = "Apr"
            elif current.month == 4: month = "May"
            elif current.month == 5: month = "Jun"
            elif current.month == 6: month = "Jul"
            elif current.month == 7: month = "Aug"
            elif current.month == 8: month = "Sep"
            elif current.month == 9: month = "Oct"
            elif current.month == 10: month = "Nov"
            elif current.month == 11: month = "Dec"
